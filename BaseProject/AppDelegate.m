...
{
    if (!_sideMenu) {
        _sideMenu = [[RESideMenu alloc]initWithContentViewController:[LastHandTabBarController standardInstance] leftMenuViewController:[LeftViewController new] rightMenuViewController:nil];
        //为sideMenu设置背景图，图片插件KSImageName,到Github下载
        _sideMenu.backgroundImage = [UIImage imageNamed:@"1"];
        //可以让出现菜单时不显示状态栏
